...
import com.template.contracts.AssetContract.Companion.ASSET_CONTRACT_ID
import com.template.flowsimport.FlowLogicCommonMethods
...
object CreateAssetStateFlow {
    ...
    class Initiator(val cusip: String,
        ...
        override fun call(): SignedTransaction {
            println("in flow: call function started")
...
println("Transaction building done")
